...
const CloudIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="47" height="27" viewBox="0 0 47 27" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
const BackHillIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="393" height="100" viewBox="0 0 393 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M-10 80 C 150 0, 250 120, 410 40 V 100 H -10 Z" fill="#025402" />
    </svg>
);

const TopLevelHillsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="393" height="124" viewBox="0 0 393 124" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-gradient-to-b from-pink-200 via-purple-200 to-amber-100">
      ...
      <div className="absolute bottom-0 left-0 w-full h-[55%]">
        <BackHillIcon className="absolute bottom-0 left-0 w-full h-auto" preserveAspectRatio="none" />
        <TopLevelHillsIcon className="absolute bottom-0 left-0 w-full h-auto" preserveAspectRatio="none" />
      </div>
    </div>
  );
};

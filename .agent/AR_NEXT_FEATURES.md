...
- Pet interacts with objects (climbs, hides behind)
- Background
...
- **Global High Scores** (catch game)
- **Friend Leaderboard** (if social features enabled)
- **Achievements**:
  - "First Steps" - Play AR mode for first time
  - "Master Catcher" - Score 500+ in catch game
  - "Pet Whisperer" - 100 pet interactions
  - "Week Warrior" - 7 day streak
  - "Energy Champion" - Maintain 90%+ energy for 3 days
